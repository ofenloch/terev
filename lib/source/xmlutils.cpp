...
xmlutils::parseFile(std::string fileName)
{
 ...
 */
/*static*/ int
xmlutils::getNodeLevel(Poco::XML::Node *pNode)
{
...
/*static*/ int
xmlutils::saveNodeToFile(Poco::XML::Node *pNode, std::string fileName)
{
...
/*static*/ std::string
xmlutils::getAttribute(Poco::XML::Node *pNode, std::string attrName)
{
    return ((Poco::XML::Element *)pNode)->getAttribute(attrName);
}

/*static*/ void
xmlutils::setAttribute(Poco::XML::Node *pNode, std::string attrName, std::string attrValue)
{
    ((Poco::XML::Element *)pNode)->setAttribute(attrName, attrValue);
}

/*static*/ void
xmlutils::duplicateNode(Poco::XML::Node *pNode)
{
...
/*static*/ int
xmlutils::normalizeXMLFile(const std::string &inFileName, const std::string &outFileName)
{
...
/*static*/ int
xmlutils::createTestFile(const std::string &fileName)
{
